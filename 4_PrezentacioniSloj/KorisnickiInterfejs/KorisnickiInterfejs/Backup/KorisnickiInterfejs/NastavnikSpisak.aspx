<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="NastavnikSpisak.aspx.cs" Inherits="KorisnickiInterfejs.NastavnikSpisak" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="style1">
            &nbsp;</td>
        <td class="style3">
            <strong>SPISAK NASTAVNIKA</strong></td>
        <td>
            &nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="style1">
            &nbsp;</td>
        <td class="style2">
            <asp:GridView ID="gvNastavnici" runat="server" Height="199px" Width="484px">
            </asp:GridView>
        </td>
        <td>
            &nbsp;</td>
